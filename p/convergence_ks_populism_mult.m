...
etalgrid = linspace(0, .7, 4);
taupgrid = linspace(0, .7, 4);

cd ../d/
for i = 1:4
    terms.etagrid = [etalgrid(i) etap];
    while foredist > vTol
    ...
    filename = sprintf("KS_migration_results_eta_%0.2f_.mat", etalgrid(i));
    save(filename)
end

terms.etagrid = [0 0];
for i = 1:4
    terms.taugrid = [0 taupgrid(i)];
    while foredist > vTol
    ...
    filename = sprintf("KS_migration_results_tau_%0.2f_.mat", taupgrid(i));
    save(filename)
end
